    ...
    public Object execute(Object[] args) throws InvalidApiHookException,
        ...
        if (mode.equalsIgnoreCase("AREA_GET_OWNERS")) {
            ...
            converted = new Object[] {
                    mode,
                    CServer.getServer().getWorld(w.getName(),
                            w.getType().getId()), (String) args[2] };
        } else if (mode.equalsIgnoreCase("AREA_GET_PLAYERLIST")
                || mode.equalsIgnoreCase("AREA_GET_GROUPLIST")) {
            ...
            converted = new Object[] {
                ...
                || mode.equalsIgnoreCase("AREA_ADD_GROUP")) {
            hook = new AreaActionHook();
            World w = (World) args[1];
            converted = new Object[] {
                    mode,
                ...
                || mode.equalsIgnoreCase("AREA_REMOVE_GROUP")) {
            hook = new AreaActionHook();
            World w = (World) args[1];
            converted = new Object[] {
                    mode,
            ...
            World w = (World) args[1];
            CWorld world = CServer.getServer().getWorld(w.getName(),
                    w.getType().getId());
            converted = new Object[] { mode, world, (String) args[2],
                    (String) args[3] };
            ...
            throw new InvalidApiHookException(
                    "Catched an invalid hook call, check this! Hook: " + mode);
        }
