...
public class MessageSystem {
    ...
    private MessageSystem() {
        ...
        messages.put("blockFireSpreadDisabled",
                "Firespread is now enabled! (it spreads)");

        messages.put("creeperSecureEnabled", "Creeper Security is now enabled!");
        messages.put("creeperSecureDisabled",
                "Creeper Security is now disabled! (they go boom)");
        ...
        messages.put("lavaFlowControlEnabled",
                "Lava Flow Control is now enabled!");
        messages.put("lavaFlowControlDisabled",
                "Lava Flow Control is now disabled!");

        messages.put("waterFlowControlEnabled",
                "Water Flow Control is now enabled!");
        messages.put("waterFlowControlDisabled",
                "Water Flow Control is now disabled!");
        ...
        messages.put("sanctuaryAnimalSpawnEnabled",
                "Sanctuary now spawns animals!");
        messages.put("sanctuaryAnimalSpawnDisabled",
                "Sanctuary does not spawn animals now!");
        ...
        messages.put("welcomeSet", "Welcome message has been set!");
        messages.put("farewellSet", "Farewell message has been set!");
        ...
        messages.put("selectionDeleted",
                "The blocks in your selection have been removed!");

        messages.put("brushSet", "Your brush properties have been set");
        messages.put("copiedToClipboard",
                "Blocks have been copied to your personal clipboard");
        messages.put("selectionPasted",
                "Your selection has been pasted into the world!");
        ...
        messages.put("pyramidCreated",
                "A pyramid has been created! Egyptian spirits!");
        ...
        messages.put("selectionExpanded",
                "Selection has been expanded! (Bottom-to-Top)");
        ...
        messages.put("globalSanctuaryASOn",
                "Global Sanctuary animal spawn enabled!");
        messages.put("globalSanctuaryASOff",
                "Global Sanctuary animal spawn disabled!");
        ...
        messages.put("globalPhysicsControlOn",
                "Global Physics control enabled!");
        messages.put("globalPhysicsControlOff",
                "Global Physics control disabled!");

        messages.put("globalEnderControlOn", "Global Enderman control enabled!");
        messages.put("globalEnderControlOff",
                "Global Enderman control disabled!");

        messages.put("firstPointSet", "First point has been set!");
        messages.put("secondPointSet", "Second point has been set!");

        messages.put("pointsLoaded",
                "The areas points have been loaded into your selection.");
        ...
        errors.put("cuboidNotFoundOnCommand",
                "There was no Cuboid with the provided name!");
        errors.put("cuboidNotRemovedHasChilds",
                "Cuboid was not removed. It has child elements!");
        errors.put("cuboidNotRemovedNotFound",
                "Cuboid was not removed. It was not found!");
        errors.put("cuboidNotRemovedError",
                "Cuboid was not removed. Bugmonster ate the code :S");
        errors.put("cuboidExists", "A cuboid with this name already exists!");
        errors.put("invalidBlock", "The provided block was invalid!");
        errors.put("selectionIncomplete",
                "The selection is not completed. Please set start and end point!");
        ...
        errors.put("selectionNotDeleted",
                "The blocks in your selection have not been removed!");
        errors.put("cuboidNotCreated",
                "Your Cuboid has not been created. Choose a different name!");
        errors.put(
                "invalidRadius",
                "The selected radius is invalid. What did you do, put a char instead of a number? Dude!");
        errors.put(
                "invalidCardinalDirection",
                "You specified an invalid cardinal direction! Use SOUTH/WEST/NORTH/EAST/UP/DOWN");
        errors.put(
                "selectionNotMoved",
                "Your selection has not been moved! Blocks seem to be move resistant. Try again.");
        errors.put("selectionNotPasted",
                "Your selection has not been pasted. The bugmonster ate it!");
        errors.put("originNotSet",
                "You must specify the first point for this operation!");
        ...
        errors.put("invalidHeight",
                "The height you specified was invalid! (How can you fail at this?)");
        ...
        errors.put("notWithinSpecifiedParent",
                "Cuboid is not within the specified parent node.");
        errors.put("invalidAreaProperty",
                "Unknown area property. Did not toggle!");
        errors.put("invalidGlobalProperty",
                "Unknown global property. Did not toggle!");
        errors.put("playerNotTeleportedDenied",
                "Not teleported! You're not allowed in this area and it is restricted!");
        errors.put("clipboardEmpty",
                "There is nothing to paste in your clipboard");
    }
    ...
    public static void customMessage(CPlayer player, String color,
            String message) {
