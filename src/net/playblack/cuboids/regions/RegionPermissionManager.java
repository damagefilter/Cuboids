...
/**
 * This is one of the most monstrous classes in here.
 * It takes care of what a player can or cannot do inside a cuboid node
 * @author Chris
 *
 */
public class RegionPermissionManager {
    ...
    public RegionPermissionManager(RegionManager rm, EventLogger log) {
        regions = rm;
        this.log = log;
    }
