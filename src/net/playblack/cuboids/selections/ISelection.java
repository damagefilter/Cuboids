...
public interface ISelection {
    ...
    /**
     * Get a block from the specified coordinate storage in this selection. May return null
     * @param v
     * @return
     */
    ...
    /**
     * Get the boundary size. That is: the volume of this selection (number of blocks in the world that are encompassed by this selection)
     * @return
     */
