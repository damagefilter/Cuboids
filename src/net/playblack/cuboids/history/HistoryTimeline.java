...
/**
 * Every player has a history timeline where blocks are stored that have been modified into a linked list.
 * @author Chris
 *
 */
public class HistoryTimeline {
    ...
    /**
     * Clear the history, that will also free up some memory with the next GC cycle
     */
    public void clear() {
        history.clear();
        pointer = 0;
    ...
    /**
     * Go back one step in history and return the historyobject created back then
