...
/**
 * Sends log messages to the server log. This also creates Cuboid Area logs for
 * Griefer monitoring and stuff. (Once it's implemented that is) TODO: monitored
 * flag for areas
 * 
 * @author chris
 * 
...
public class EventLogger {
    ...
    /**
     * Directly send a message to the server log. If there is a cache active,
     * this will be appended to the cache instead so the order of task execution
     * keeps synchronized in the resulting logs.
     * 
     * @param message
     * @param level
     *            the log level, can use INFO, WARNING and SEVERE
     */
    public void logMessage(String message, String level) {
        ...
        if (level.equalsIgnoreCase("INFO")) {
            ...
            // if(true) { //TODO: set this to a config variable once this bug
            // terror is over!
            // log.log(Level.INFO, "Cuboids2: " + message);
            // }
        }
